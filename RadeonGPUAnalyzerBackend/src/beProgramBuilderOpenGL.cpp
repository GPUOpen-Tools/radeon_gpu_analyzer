...
static bool  VerifyVirtualContextOutput(const OpenGLOptions& options)
{
    ...
    {
        ret &= beUtils::isFilePresent(options.m_programBinaryFile.asASCIICharArray(), true);
    }
    if (ret && options.m_isCfgRequired)
    {
        ret &= beUtils::isFilePresent(options.m_controlFlowGraphOutputFiles.m_computeShader.asASCIICharArray(), !options.m_pipelineShaders.m_computeShader.isEmpty());
        ret &= beUtils::isFilePresent(options.m_controlFlowGraphOutputFiles.m_fragmentShader.asASCIICharArray(), !options.m_pipelineShaders.m_fragmentShader.isEmpty());
        ret &= beUtils::isFilePresent(options.m_controlFlowGraphOutputFiles.m_geometryShader.asASCIICharArray(), !options.m_pipelineShaders.m_geometryShader.isEmpty());
        ret &= beUtils::isFilePresent(options.m_controlFlowGraphOutputFiles.m_tessControlShader.asASCIICharArray(), !options.m_pipelineShaders.m_tessControlShader.isEmpty());
        ret &= beUtils::isFilePresent(options.m_controlFlowGraphOutputFiles.m_tessEvaluationShader.asASCIICharArray(), !options.m_pipelineShaders.m_tessEvaluationShader.isEmpty());
        ret &= beUtils::isFilePresent(options.m_controlFlowGraphOutputFiles.m_vertexShader.asASCIICharArray(), !options.m_pipelineShaders.m_vertexShader.isEmpty());
    }
