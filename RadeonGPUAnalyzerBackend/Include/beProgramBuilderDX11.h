...
public:
    ...
    virtual beKA::beStatus Compile(RgaMode mode, const std::string& programSource, const DXOptions& dxOptions, bool isDxbcInput);
...
private: // functions
    ...
    beKA::beStatus CompileAMDIL(const std::string& programSource, const DXOptions& dxOptions);
    beKA::beStatus CompileHLSL(const std::string& programSource, const DXOptions& dxOptions, bool isDxbcInput);
