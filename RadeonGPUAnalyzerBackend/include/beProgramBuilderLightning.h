...
public:
    ...
    static beStatus GetCompilerVersion(RgaMode mode, const std::string& userBinDir, bool printCmd, std::string& outText);
...
protected:
    ...
    static beStatus AddCompilerStandardOptions(RgaMode mode, const CmplrPaths& cmplrPaths, std::string& options);
    ...
    static beStatus InvokeCompiler(RgaMode mode, const std::string& userBinFolder, const std::string& cmdLineOptions,
