...
// - GR_GENERIC_LINUX_VARIANT - Generic Linux variant (Red Hat, Suse, etc)
// - GR_MAC_OS_X_LINUX_VARIANT - Mac OS X
#define GR_GENERIC_LINUX_VARIANT 1
#define GR_MAC_OS_X_LINUX_VARIANT 2
#define GR_ANDROID_LINUX_VARIANT 3
...
// - GR_WIN32 - Window
// - GR_LINUX - Linux
#define GR_WINDOWS_OS   1
#define GR_LINUX_OS     2

// The current build target will be contained in GR_BUILD_TARGET:
#if defined(_WIN32)
    #define GR_BUILD_TARGET GR_WINDOWS_OS
#elif defined (__APPLE__)
    #define GR_BUILD_TARGET GR_LINUX_OS
    #define GR_LINUX_VARIANT GR_MAC_OS_X_LINUX_VARIANT
#elif defined(__ANDROID__)
    #define GR_BUILD_TARGET GR_LINUX_OS
    #define GR_LINUX_VARIANT GR_ANDROID_LINUX_VARIANT
#elif defined(__linux__)
    #define GR_BUILD_TARGET GR_LINUX_OS
    #define GR_LINUX_VARIANT GR_GENERIC_LINUX_VARIANT
#else
...
// - GR_32_BIT_ADDRESS_SPACE - 32 bit address space.
// - GR_64_BIT_ADDRESS_SPACE - 64 bit address space.
#define GR_32_BIT_ADDRESS_SPACE     1
#define GR_64_BIT_ADDRESS_SPACE     2

// The address space will be contained in GR_ADDRESS_SPACE_TYPE:
#if GR_BUILD_TARGET == GR_WINDOWS_OS
    #ifdef _WIN64
        #define GR_ADDRESS_SPACE_TYPE GR_64_BIT_ADDRESS_SPACE
    #else
...
#define GR_VISUAL_CPP_COMPILER  1
#define GR_GNU_CPP_COMPILER     2

#if defined(_MSC_VER)
    #define GR_CPP_COMPILER GR_VISUAL_CPP_COMPILER
    #define GR_VISUAL_CPP_COMPILER_VERSION _MSC_VER
#elif defined(__GNUC__)
    #define GR_CPP_COMPILER GR_GNU_CPP_COMPILER
    #define GR_GNU_CPP_COMPILER_VERSION __GNUC__
    #define GR_GNU_CPP_COMPILER_MINOR_VERSION __GNUC_MINOR__
#else
    #error Error: Unknown compiler
#endif

#if GR_CPP_COMPILER == GR_VISUAL_CPP_COMPILER
    #define GR_HAS_CPP0X 1
#else
...
#define GR_DEBUG_BUILD 1
#define GR_RELEASE_BUILD 2

// The used build configuration will be contained in GR_BUILD_CONFIGURATION:
#if defined(_DEBUG)
    #define GR_BUILD_CONFIGURATION GR_DEBUG_BUILD
#elif defined(NDEBUG)
    #define GR_BUILD_CONFIGURATION GR_RELEASE_BUILD
#else
...
// The supported build configurations:
#define GR_PUBLIC_ACCESS 1
#define GR_NDA_ACCESS 2
#define GR_INTERNAL_ACCESS 3

#if defined (GDT_INTERNAL)
    #define GR_BUILD_ACCESS GR_INTERNAL_ACCESS
#elif defined (GDT_NDA)
    #define GR_BUILD_ACCESS GR_NDA_ACCESS
#elif defined (GDT_PUBLIC)
    #define GR_BUILD_ACCESS GR_PUBLIC_ACCESS
#else
...
// The error codes are defined in gtDefinitions.h (above) and WinError.h.
//
GT_API const wchar_t* gtGetErrorString(const HRESULT errCode);

#endif  // __GTDEFINITIONS
