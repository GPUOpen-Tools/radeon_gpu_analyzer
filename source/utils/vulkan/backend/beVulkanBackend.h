...
/// @file
/// @brief Header for vulkan backend class.
//=============================================================================
...
struct RgConfig
{
    ...
    std::array<std::string, RgPipelineStage::kCount> spv_files;

    // Entry points.
    std::array<std::string, RgPipelineStage::kCount> entries;

    // Stage-specific output ISA file paths.
    std::array<std::string, RgPipelineStage::kCount> isa_files;

    // Stage-specific output statistics file paths.
    std::array<std::string, RgPipelineStage::kCount> stats_files;
