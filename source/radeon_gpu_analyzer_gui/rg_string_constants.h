...
static const char* kStrErrorMultisamplingSampleMaskInvalidA = "The multisampling state 'rasterizationSamples' field is incompatible with the value of 'pSampleMask'.";
static const char* kStrErrorMultisamplingSampleMaskInvalidB = "Please adjust the 'rasterizationSamples' field or alter the dimension of 'pSampleMask' as required by the Vulkan spec.";
...
static const char* kStrBuildSettingsCmdLineTooltip = "The command line options that are going to be passed to the rga command line tool based on the values on this page.";
...
static const char* kStrTableTooltipColumnComputeCapability  = "Name of the architecture variant. From the compiler's point of view, GPUs with the same compute capability are identical.";
...
static const char* kStrBuildSettingsPredefinedMacrosTooltip = "Predefined macros should be separated by ';'. If a macro definition includes a space, surround it with parentheses.";
static const char* kStrBuildSettingsAdditionalIncDirectoryTooltip = "Additional include directories should be separated by ';'. If a path includes a space, surround it with parentheses.";
...
static const char* kStrBuildSettingsAlternativeCompilerGlslangTooltip = "Settings for the front-end compiler (glslang), as well as tools such as disassembler and assembler.";
static const char* kStrBuildSettingsAlternativeCompilerTooltipGeneric = "To use an alternative compiler, provide the following paths.\nOtherwise, the default compiler, which is bundled with RGA, will be used.";
static const char* kStrBuildSettingsSettingsCmdlineTooltip = "The command string which will be passed to the RGA backend when it is invoked. This command is generated according to the above selected settings.";
...
static const char* kStrGlobalSettingsCheckboxTooltip = "If checked, RGA will always use the auto-generated project name, without prompting for a rename when creating a new project.";
static const char* kStrGlobalSettingsLogFileLocation = "The directory where RGA will save log files. RGA will delete log files that are older than 3 days upon startup.";
...
static const char* kStrGlobalSettingsSrcViewIncludeFilesViewerTooltip = "When trying to open header files from the source code viewer, RGA would use the system's default app. To override this behavior, use this setting to provide a full path to an alternative viewer.";
static const char* kStrGlobalSettnigsFileExtGlslTooltip = "Treat files with these extensions as GLSL source files. By default, RGA would treat files with unknown extensions as SPIR-V binary files.";
static const char* kStrGlobalSettnigsFileExtHlslTooltip = "Treat files with these extensions as HLSL source files. By default, RGA would treat files with unknown extensions as SPIR-V binary files.";
static const char* kStrGlobalSettnigsFileExtSpvTxtTooltip = "Treat files with these extensions as SPIR-V text files. By default, RGA would treat files with unknown extensions as SPIR-V binary files.";
...
static const char* kStrGlobalSettingsDefaultStartupApiTooltip = "If this setting is set, RGA will automatically start in the specified mode, without showing the startup dialog where the desired mode can be selected.";
...
static const char* kStrGlobalSettingsSpvExtensionsTooltip = "Since RGA assumes SPIR-V binary as an input by default, use this option to specify file filters for SPIR-V binary files. When showing the Add Existing File dialog, RGA would dynamically use these file filters.";
