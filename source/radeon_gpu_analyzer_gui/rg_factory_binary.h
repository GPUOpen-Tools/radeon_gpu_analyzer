...
/// @file
/// @brief Header for the factory used to create Binary analysis mode object instances.
//=============================================================================
#pragma once
// C++.
#include <memory>
...
class RgFactoryBinary : public RgFactory
{
public:
    ...
    // Apply the stylesheet for the Binary file menu.
