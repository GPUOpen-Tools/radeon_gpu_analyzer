...
public:
    ...
    static beStatus GetVulkanDriverTargetGPUs(const std::string&     loader_debug,
    ...
    static beStatus GetPhysicalGPUs(const std::string& icd_file, std::vector<BeVkPhysAdapterInfo>& gpu_info, bool should_print_cmd, std::string& error_text);
    ...
    static beStatus AssembleSpv(const std::string& spv_tools_bin_dir,
    ...
    static beStatus PreprocessSource(const Config&      config,
...
private:
    ...
    static beStatus InvokeGlslang(const std::string& glsl_bin_path,
    ...
    static beStatus InvokeSpvTool(BeVulkanSpirvTool  tool,
    ...
    static beStatus InvokeVulkanBackend(const std::string& cmd_line_options, bool should_print_cmd, std::string& out_text, std::string& error_txt);
};
