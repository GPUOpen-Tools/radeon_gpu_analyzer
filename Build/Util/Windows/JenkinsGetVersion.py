...
#
# Usage:
#    python <workspace>\RGA\Build\JenkinsGetVersion.py --major|minor|update
#      --major     Return major version number
#      --minor     Return minor version number
#      --update    Return update (revision) version number
#
import os
import argparse
...
with open(RGAVersionFile) as f:
    RGAVersionData = f.readlines()
