...
class rgEditorElementArray : public rgEditorElement
{
    Q_OBJECT

public:
    rgEditorElementArray(QWidget* pParent, const std::string& memberName, std::function<void(int)> elementRemovedCallback = nullptr);
    virtual ~rgEditorElementArray() = default;
...
private:
    ...
    rgPipelineStateEditorWidgetArray* m_pEditorWidget = nullptr;
