#ifndef kcDataTypes_h__
    #define kcDataTypes_h__
    #include <string>
    ...
    // Vector of pairs {entry_name, src_line}
    typedef  std::vector<std::pair<std::string, int>>  rgEntryData;
