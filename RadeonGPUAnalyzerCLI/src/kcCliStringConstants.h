    ...
    const char* const STR_RGA_VERSION = "1.4";
...
#define STR(x) STR_HELPER(x)
    ...
    const char* const STR_RGA_BUILD_DATE_DEV = "Dev";
    ...
    #define STR_CSV_PARSED_ISA_HEADER_LINE_NUMS  "Address, Source Line Number, Source Line Text, Opcode, Operands, Functional Unit, Cycles, Hex\n"
